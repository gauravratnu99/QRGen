    ...
    <div id="download-section-container" className="space-y-4">
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className="hidden sm:flex items-center gap-1.5 text-xs font-medium px-3 py-1.5 rounded-xl bg-cyan-500/10 hover:bg-cyan-500/20 text-cyan-300 border border-cyan-500/30 transition-all hover:shadow-lg hover:shadow-cyan-500/10 active:scale-95 disabled:opacity-50"
        >
            ...
            <button
              ...
              className={`group relative flex items-start justify-between p-4 rounded-2xl border text-left transition-all duration-200 ${
                isDone
                  ...
                  : 'bg-slate-900/60 hover:bg-slate-850 border-white/5 hover:border-cyan-500/30 hover:shadow-xl hover:shadow-cyan-500/5 active:scale-[0.99]'
              }`}
            >
              <div className="space-y-1">
                <div className="flex items-center gap-2">
                  <div className="p-1.5 rounded-lg bg-white/5 group-hover:bg-cyan-500/10 text-slate-300 group-hover:text-cyan-300 transition-colors">
                    {opt.format === 'svg' ? (
                ...
                <p className="text-xs text-slate-400 pl-8">{opt.description}</p>
                <div className="text-[11px] text-cyan-400/80 pl-8 font-medium">
                  {opt.recommendedFor}
                </div>
              </div>
              ...
              <div className="ml-2 pt-1 shrink-0">
                {isProcessing ? (
                  ...
                  <div className="w-7 h-7 rounded-xl bg-emerald-500/20 border border-emerald-500/30 flex items-center justify-center text-emerald-300 animate-in zoom-in">
                    <Check className="w-4 h-4" />
                  </div>
                ) : (
                  <div className="w-7 h-7 rounded-xl bg-white/5 group-hover:bg-cyan-500/20 border border-white/10 group-hover:border-cyan-500/30 flex items-center justify-center text-slate-400 group-hover:text-cyan-300 transition-all">
      ...
      <button
        ...
        onClick={handleDownloadAll}
        disabled={downloadingFormat !== null}
        className="sm:hidden w-full flex items-center justify-center gap-2 py-3 rounded-xl bg-gradient-to-r from-cyan-500/20 via-teal-500/20 to-indigo-500/20 hover:from-cyan-500/30 hover:to-indigo-500/30 border border-cyan-500/30 text-xs font-semibold text-cyan-200 transition-all active:scale-[0.98] disabled:opacity-50"
      >
        {downloadingFormat === 'all' ? (
